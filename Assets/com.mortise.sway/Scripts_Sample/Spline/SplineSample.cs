    ...
    public class SplineSample : MonoBehaviour {
        ...
        void UpdateLine() {
            ...
            for (int i = 0; i < resolution; i++) {
                FVector3 pos = SplineHelper.Easing(ps[0].FPos, ps[1].FPos, ps[2].FPos, ps[3].FPos,
                i, resolution, type);
                Vector3 position = new Vector3(pos.x, pos.y, 0f) + transform.position;
                lineRenderer.SetPosition(i, position);
            }

            var length = SplineHelper.CalculateSplineLength(ps[0].FPos, ps[1].FPos, ps[2].FPos, ps[3].FPos, type, resolution);
        ...
        private void Update() {
            ...
            var pos = SplineHelper.Easing(ps[0].FPos, ps[1].FPos, ps[2].FPos, ps[3].FPos,
